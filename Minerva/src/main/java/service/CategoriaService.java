...
public class CategoriaService {
	...
	public Object renderCategoriaEspecifica(Request request, Response response) {
		...
		String page = util.renderHeader();
			...
			page += "  <section class=\"secao_categoria_especifica\">\r\n"
				 + "  	<div class=\"limite-site\">"
		        + "       <h2 class=\"h-principal h-categorias\" style=\"margin-top:100px;\">"+categoria.getNomeCategoria()+"</h2>\r\n"
				+ "  		<div class=\"filtro-categorias\">\r\n"
				+ "  			<a href="+paramId+"><button type=\"button\" class=\"btn btn-outline-primary botao-filtro\">Todos</button></a>\r\n";
		
		
		for(SubcategoriaModel subcategoria: subcategorias) {
			page += "<a href="+paramId+ "/" + subcategoria.getIdSubcategoria()+">";
	...
	public Object atualizaPaginaCategoriaComSub(Request request, Response response) {
		String subcat = request.params("subcategoria");
		int paramId = Integer.parseInt(request.params("id"));
		ArtistaDao conexaoArtista = new ArtistaDao();
		List<ArtistaModel> artistas = conexaoArtista.getArtistasByCategoriaAndSub(request.params("id"), subcat);
		SubcategoriaDao conexaoSubcategoria = new SubcategoriaDao();
		SubcategoriaModel subcatMod = conexaoSubcategoria.get(Integer.parseInt(subcat));
		...
		String page = "<!DOCTYPE html>\r\n"
				...
				+ "  <link rel=\"stylesheet\" href=\"http://localhost:6789/style\\style.css\">\r\n"
				+ "  <link rel=\"stylesheet\" href=\"http://localhost:6789/style\\arthur.css\">\r\n"
		...
		page += "<h2 class=\"h-principal h-categorias\" style=\"margin-top:100px;\">"+subcatMod.getNomeSubcategoria()+"</h2>\r\n"
				+ "  		<div class=\"filtro-categorias\">\r\n"
				+ "  			<a href=\"http://localhost:6789/categorias/"+paramId+"\"><button type=\"button\" class=\"btn btn-outline-primary botao-filtro\">Todos</button></a>\r\n";
