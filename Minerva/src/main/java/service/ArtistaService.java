...
public class ArtistaService {
			...
			if(artistas.isEmpty()) {
				...
				for(ArtistaModel a: artistas) {
					...
					page += "   				<div class=\"col col-tiny-12 col-small-6 col-3 col-medium-3\">\r\n"
							...
							+ " 							<p class=\"card-text card-categoria\">"+a.getNomeSubcategoria()+"</p>\r\n"
	...
	public Object insertProduto(Request request, Response response) throws IOException, ServletException {
        ...
        String uploadPath = "imagens/" + "Planet23.jpg";
        ...
        ProdutoModel produto = new ProdutoModel(2, "..\\images\\Planet23.jpg", "Produto exemplo para apresentação");
        ProdutoArtistaDao conexaoProduto = new ProdutoArtistaDao();
        conexaoProduto.insert(produto);
        ...
        return "<!DOCTYPE html>\r\n"
        		...
        		+ "				<h3 style=\"text-align: center;margin-bottom: 25px;margin-top: 16px;\">Produto cadastrado com sucesso!</h3>\r\n"
        		+ "				</div>\r\n"
        		+ "				<div class=\"col-4\"></div>\r\n"
        		+ "			</div>\r\n"
        		+ "		</div>\r\n"
